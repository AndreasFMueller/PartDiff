...
\input{3-geometry/geometry.tex}
\input{4-separation/separation.tex}
\input{5-transformation/transformation.tex}
\input{6-2ord/pdgl2ord.tex}
\input{7-elliptic/elliptic.tex}
\input{8-parabolic/parabolic.tex}
\input{9-hyperbolic/hyperbolic.tex}
\input{a-nonlinear/nonlinear.tex}
\appendix
\input{b-sinh/sinh.tex}
