...
die Kugeln oder B"alle \marginpar{\tiny B"alle in $\mathbb R^n$}, f"ur die 
...
Fl"ache,
\marginpar{\tiny $n-1$-dimensionale Sph"aren in $\mathbb R^n$}
die wir mit
...
In diesem Kapitel ist $\Omega\subset\mathbb R^n$ ein Gebiet im
\marginpar{\tiny Gebiete sind offene Teilmengen $\Omega\subset\mathbb R^n$}
...
$$\Delta u=f$$
\marginpar{\tiny Ableitungen sind nur auf offenen Mengen sinnvoll definiert}
...
\marginpar{\tiny Rand $\partial \Omega$ eines Gebietes}
...
\marginpar{\tiny F"ur Neumann-Randbedingen muss der Rand gen"ugend glatt sein}
...
Setzt man $-u$ in den eben bewiesenen Satz, folgt das Minimum-Prinzip:
\begin{satz}
Ist $L$ ein elliptischer Differentialoperator auf einem zusammenh"angenden
und beschr"ankten Gebiet $\Omega$,
...
dass mindestens etwas "ahnliches durchaus im Bereich des M"oglichen
liegen k"onnte.
