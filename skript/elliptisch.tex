...
L"osung $u_p$ der Laplace-Gleichung (\ref{elliptisch:laplaceequation}).
...
$\Delta u_h=0$ in $\Omega$ und $u_h=0$ auf $\partial\Omega$ erf"ullt.
\end{enumerate}
...
\]
ebenfalls eine L"osung von (\ref{elliptisch:laplaceequation}). Insbesondere
...
\]
die L"osung des Dirichlet-Problems (\ref{elliptisch:laplaceequation}) und
...
an die Koeffizienten auch f"ur beliebige elliptische Operatoren
\[
