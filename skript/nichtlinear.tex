...
der andere Faktor eine Tangente sein musste.
Bei nichtlinearen Gleichungen kann man die Idee ebenfalls
anwenden, doch ist es etwas aufwendiger, die Bedingungen zu
formulieren.

\subsection{Lagrange-Charpit Gleichungen}
\index{Lagrange}
\index{Charpit}
\index{Lagrange-Charpit Gleichungen}
