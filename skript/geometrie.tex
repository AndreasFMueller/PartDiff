...
Das Argument funktionert aber f"ur jede beliebige L"osungsfl"ache:
die Normale ist immer senkrecht auf dem Vektor $\vec n$.
Die von der Differentialgleichung erlaubten Normalenrichtungen sind
L"osungen einer lineare Gleichung, liegen also alle in einer Ebene,
und $\vec n$ muss die Normale dieser Ebene sein.
