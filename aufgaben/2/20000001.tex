Finden Sie für die folgenden partiellen Differentialgleichungen die
Funktion $F$
\begin{teilaufgaben}
...
\begin{loesung}
\begin{teilaufgaben}
\item $F(t_{12})=t_{12}$, setzt man für $t_{12}$ die gemischte partielle
Ableitung ein, erhält man
\[
F\biggl(\frac{\partial^2 u}{\partial x_1\partial x_2}\biggr)=0.
\]
\item
$F(p_1,p_2)=p_1-p_2$, ersetzt man $p_i$ durch die erste 
partielle Ableitung von $u$ nach $x_i$, erhält man
\[
