...
\begin{equation}
x^2\frac{\partial}{\partial x}\mathscr{L}u(x,s) + s\mathscr{L}u(x,s) - u(x,0)=0.
\end{equation}
Der letzte Term fällt wegen der zweiten Randbedingung weg.
Wir schreiben $y_s(x)=\mathscr{L}u(x,s)$, und suchen jetzt also eine Lösung
...
\[
y_s(1)=\mathscr{L}u(1,s)=\frac1{s^2}=C(s)e^{s}
