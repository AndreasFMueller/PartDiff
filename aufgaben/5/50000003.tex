Führen Sie die Differentialgleichung
\[
...
\[
\mathscr{L}u(s,x)=\int_0^{\infty}e^{-ts}u(t,x)\,dt
\]
...
&=
-\frac{\partial u}{\partial t}(0,x)
-s\,u(0,x)+s^2\mathscr{L}u(s,x)
\end{align*}
Der Term mit der ersten Ableitung fällt nach Voraussetzung weg.
Die Differentialgleichung für $\mathscr{L}u$ wird dann
\begin{align*}
\frac1{1-x^2}\frac{\partial^2}{\partial x^2}\mathscr{L}u
+s(1-x^2)-s^2\mathscr{L}u(s,x)
&=0
\\
\frac1{1-x^2}\frac{\partial^2}{\partial x^2}\mathscr{L}u
-s^2\mathscr{L}u(s,x)
...
für $\mathscr{L}u$ in der unabhängigen Variablen $x$.
Aus der Randbedingung folgt ausserdem $\mathscr{L}u(s,\pm 1)=0$.
\end{loesung}
