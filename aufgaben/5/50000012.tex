...
\[
s\mathscr{L}u(x,s) - \underbrace{u(x,0)}_{\displaystyle =0}
+ 3\frac{\partial }{\partial x}\mathscr{L}u(x,s)
=
-\frac1x\mathscr{L}u(x,s).
\]
Der besseren Übersicht halber kürzen wir $\mathscr{L}u(x,s)=y_s(x)$ ab
und erhalten
\begin{align*}
...
\[
\mathscr{L}u(1,s) = \frac1{s^2} = y_s(1)=C(s) e^{-s/3}
\qquad
\Rightarrow
\qquad
C(s) = \frac{e^{s/3}}{s^2}.
