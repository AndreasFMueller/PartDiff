...
Wir schreiben $\hat u(t,k)$ für die Fourier-Transformation und $\mathscr{L} u$
...
\begin{align*}
s\mathscr{L}\hat u(s,k) - \hat u(0,k)&=-k^2 \mathscr{L}\hat u(s,k)\\
(s+k^2)\mathscr{L}\hat u(s,k)&=\hat u(0,k)\\
