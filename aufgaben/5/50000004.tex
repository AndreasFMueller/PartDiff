...
\begin{hinweis}
Eine Lösung mit Separation dieser Aufgabe ist in \ref{40000004}
...
im Hinweis bereits durchgeführt ist).
...
ist eine gewöhnliche Differentialgleichung für jeden
einzelnen Fourierkoeffizienten, mit allgemeiner Lösung
\[
\hat u(t,k)=A_k\cos kt+B_k\sin kt
\]
Darin sind die Koeffizienten $A_k$ und $B_k$ aus den Anfangsbedingungen
\eqref{40000004:anfbedu} und \eqref{40000004:anfbedudot} zu bestimmen:
\begin{align*}
\hat u(0,k)&=A_k=0\\
...
\]
Damit sind die zeitabhängigen Fourierkoeffizienten $\hat u(t,k)$ bestimmt:
\[
\hat u(t,k)=
\begin{cases}
