...
Other solutions of \eqref{40000029:bc1} lead to the linearly
dependent solution function und need therefore not be considered.
...
\label{40000029:bessel}
\end{equation}
This is the Bessel equation which can be solved using Bessel functions.
\end{loesung}

\begin{diskussion}
The eigenvalue problem \eqref{40000029:evproblem} is often formulated with
a negative sign for $\lambda$, which makes the negative sign in front of
$\lambda$ in \eqref{40000029:bessel} disappear, leading to a more common
