Auf dem Gebiet $\Omega$ berandet von den vier Parabeln
\[
\begin{aligned}
y&=\frac12\biggl( \frac{x^2}{s^2}-s^2\biggr)&&\text{mit}&s&=\frac12,1\\
\text{und}\qquad
y&=\frac12\biggl(-\frac{x^2}{t^2}+t^2\biggr)&&\text{mit}&t&=\frac12,1
\end{aligned}
\]
...
y&=\frac12(t^2-s^2)
\end{align*}
sind, und dass sich in diesen Koordinaten l"asst Laplace-Operator als
\[
